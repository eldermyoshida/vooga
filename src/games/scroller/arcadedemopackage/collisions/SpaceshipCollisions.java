 ...
 * @author Jay Wang
 */
public class SpaceshipCollisions {

    private static final double FRICTION = .5;
    private CollisionDirection direction = new CollisionDirection();

    protected void spaceshipAndLevelPortalDetection (Player player, IDoor levelPortal) {
        levelPortal.goToNextLevel(player);
    }

    protected void spaceshipAndEnemyCollision (Spaceship player, IEnemy enemy) {
