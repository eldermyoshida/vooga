...
public abstract class InteractiveEntity extends GameEntity implements IAttackable{
    ...
    public boolean inRange(InteractiveEntity enemy) {
    	...
    	if(!getAttackStrategy().getWeapons().isEmpty() && distance < getAttackStrategy().getWeapons().get(getAttackStrategy().getWeaponIndex()).getRange()){
            return true;
        }
    ...
    public void update(double elapsedTime){
        ...
        if(!myAttackStrategy.getWeapons().isEmpty()){
