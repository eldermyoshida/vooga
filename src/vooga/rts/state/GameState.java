	...
	public void setupGame () {
		...
		Building b =
				new Building((new Pixmap(ResourceManager.getInstance()
						...
						new Location3D(700, 700, 0), new Dimension(100, 100), null, 1, 300, InteractiveEntity.DEFAULT_BUILD_TIME);
		...
		Garrison garrison =
				new Garrison((new Pixmap(ResourceManager.getInstance()
						.<BufferedImage> getFile("images/factory.png", BufferedImage.class))),
						new Location3D(300, 300, 0), new Dimension(100, 100), null, 1, 300, InteractiveEntity.DEFAULT_BUILD_TIME);
