 ...
 */
@Deprecated
public class OldLobbyInfo extends LobbyInfo {
     ...
     * @param ID id
     */
    public OldLobbyInfo (String lobbyName,
                              String mapName,
                              int maxPlayers,
                              int ID) {
     ...
     */
    public OldLobbyInfo (LobbyInfo lobbyInfo) {
     ...
     */
    public OldLobbyInfo (LobbyInfo lobbyInfo, int newID) {
