...
public class GameMap {
     ...
     */
    public GameMap (Tile[][] grid, Pixmap background, Dimension mapDimensions, Location destination) {
    ...
    private void sortGameElementsByDistanceToSource (
                                                     List<GameElement> elementsWithinRadius,
                                                     Location source) {
    ...
    /**
     * Used to determine if a ghost image should be painted, it tests if a tower can be built at a
     * particular point.
     * 
     * @param p
     * @return
