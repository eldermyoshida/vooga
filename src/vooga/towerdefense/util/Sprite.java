...
public abstract class Sprite {
	...
	public boolean intersects(Sprite other) {
		return this.intersects(other.getCenter())
				|| this.intersects(this.getCenter())
	...
	// FIXME: This will break many, many things if it is ever called, so we
	// should fix it. -Matthew
	/**
