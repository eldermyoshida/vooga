...
public class Projectile extends GameElement implements Attacker {
    ...
    public Projectile (GameElement initiator, Targetable target, List<Action> actions, AttributeManager attributes) {
        super(DEFAULT_IMAGE, initiator.getCenter(), DEFAULT_SIZE, DEFAULT_ACTIONS);
        myAttributeManager = attributes;

    }
    public Projectile (GameElement initiator, Targetable target, List<Action> actions) {
        super(DEFAULT_IMAGE, initiator.getCenter(), DEFAULT_SIZE, DEFAULT_ACTIONS);
