...
/**
 * A factory that creates game elements based on preset data Reads from an
 * xmlfile (eventually)
 * 
 * @author Matthew Roy
 * @author Xu Rui
...
public class GameElementFactory {
	...
	public GameElementFactory(String name, Pixmap image) {
		...
		mySize = new Dimension(50, 50);// TODO: just for testing before having
										// the xml loader
										// working
	...
	public GameElementFactory(String name, String type,
			GameElementDefinition definition) {
		this(name, type, definition.getImage(), definition.getSize(),
				definition.getAttributeManagerFactory(), definition
						.getActions());
		myName = name;
		myDef = definition;
	}
