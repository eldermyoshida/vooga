...
import vooga.towerdefense.action.movement.TrackTarget;
 ...
 * 
 */
public class TrackTargetFactory extends ActionFactory {
	private String myMoveSpeedReference;
	private int isTargetTracking;

	public TrackTargetFactory(
	...
	protected Action buildAction(GameElement e) {
		return new TrackTarget(e.getCenter(), e.getCenter(), e
