 ...
 */
public class PokemonLib implements ISpriteLibrary {
    ...
    public static class Pokeball extends StaticEntity implements ICoin {

        private static final String DEFAULT_IMG = "pokeball.png";
        ...
        public Pokeball (Location center) {
 ...
 public static class BigPikachu extends NonStaticEntity {
        
        private static final String DEFAULT_IMG = "Pikachu.png";
        ...
        public BigPikachu (Location center) {
            super(new Pixmap(DEFAULT_IMG), center, BIGMARIO_SIZE);
        }
    }

    public static class Charizard extends NonStaticEntity implements IEnemy {

        private static final String DEFAULT_IMG = "charizard.gif";
        ...
        public Charizard (Location center) {
