package vooga.scroller.sprites.test_sprites.pikachu;
...
@InputClassTarget
public class Pikachu extends Player implements IPlayer, IInputListener{
    ...
    private static final Pixmap DEFAULT_IMAGE = new Pixmap("pikachu.png");
    private static final int DEATH_PENALTY = 1000;

   
    private int myJumpCount;

    public Pikachu (Location center, Dimension size, View view, ScrollingManager sm) {
