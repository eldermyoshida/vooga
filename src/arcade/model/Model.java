...
public class Model implements ArcadeInteraction {
	...
	public void publishGame(String name, 
			...
			boolean isMP, 
			boolean isSP) {
		myDb.createGame(name, thumbnailPath, adscreenPath, agePermission, price, description, isMP, isSP);
	 ...
	 */
	public void createNewUserProfile(String username, String pw,
			String firstname, String lastname, String dataOfBirth) {
	...
	public void createNewUserProfile(String username, String pw,
			String firstname, String lastname, String dataOfBirth,
			String filepath) {
		System.out.println(myDb.createUser(username, pw, firstname, lastname,
				dataOfBirth, filepath));
