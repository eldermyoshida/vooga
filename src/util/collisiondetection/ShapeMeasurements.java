package util.collisiondetection;
...
public class ShapeMeasurements {
	 ...
	 /**
	  * This class should be solely used to return basic measurements of 
	  * Shapes: really centers and corners at this point.
	  * 
...
;		while(!path1.isDone()){
	 ...
	 /**
	  * Uses path of bounds to precisely calculate the centroid of 
	  * the shape. This is a great method to use for non-regular 
	  * polygons 
	 */
